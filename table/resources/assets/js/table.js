    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.excel",
                    BlackCMSVariables.languages.tables.excel
                        ? BlackCMSVariables.languages.tables.excel
                        : "Excel"
                )
            );
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.export",
                    BlackCMSVariables.languages.tables.export
                        ? BlackCMSVariables.languages.tables.export
                        : "Export"
                ) +
                '&nbsp;<span class="caret"/>'
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.csv",
                    BlackCMSVariables.languages.tables.csv
                        ? BlackCMSVariables.languages.tables.csv
                        : "CSV"
                )
            );
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.print",
                    BlackCMSVariables.languages.tables.print
                        ? BlackCMSVariables.languages.tables.print
                        : "Print"
                )
            );
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.reset",
                    BlackCMSVariables.languages.tables.reset
                        ? BlackCMSVariables.languages.tables.reset
                        : "Reset"
                )
            );
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.reload",
                    BlackCMSVariables.languages.tables.reload
                        ? BlackCMSVariables.languages.tables.reload
                        : "Reload"
                )
            );
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on("click", ".delete-many-entry-trigger", (event) => {
                ...
                if (ids.length === 0) {
                    BlackCMS.showError(
                        BlackCMSVariables.languages.tables.please_select_record
                            ? BlackCMSVariables.languages.tables
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                type: "GET",
                url: $modal
                    .find(".confirm-bulk-change-button")
                    .data("load-url"),
                data: {

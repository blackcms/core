...
namespace BlackCMS\Table\Http\Controllers;

use App\Http\Controllers\Controller;
use BlackCMS\Base\Http\Responses\BaseHttpResponse;
use BlackCMS\Table\Http\Requests\BulkChangeRequest;
use BlackCMS\Table\Http\Requests\FilterRequest;
...
class TableController extends Controller
{
    ...
    public function postSaveBulkChange(
        ...
        return $response->setMessage(
            trans("core/table::table.save_bulk_change_success")
        );
    }
    ...
    public function getFilterInput(FilterRequest $request)
    {
        ...
        return $object->getValueInput(null, $value, $column["type"], $choices);
    }
}

...
use BlackCMS\Setting\Facades\SettingFacade;
...
if (!function_exists("setting")) {
     ...
     * @return array|\BlackCMS\Setting\Supports\SettingStore|string|null
     */
...
if (!function_exists("get_setting_email_template_content")) {
     ...
     * @param string $type type of module is system or addons
     * @param string $module
    ...
    function get_setting_email_template_content($type, $module, $templateKey)
    {
        ...
        return File::exists($defaultPath)
            ? get_file_data($defaultPath, false)
            : "";
    }
}
...
if (!function_exists("get_setting_email_template_path")) {
    ...
    {
        return storage_path(
            "app/email-templates/" . $module . "/" . $templateKey . ".tpl"
        );
    }
}
...
if (!function_exists("get_setting_email_subject")) {
     ...
     * @param string $type : addons or core
     * @param string $name : name of addon or core component
     * @param string $templateKey : define in config/email/templates
     * @return array|\BlackCMS\Setting\Supports\SettingStore|null|string
     */
...
if (!function_exists("get_setting_email_status")) {
    ...
    function get_setting_email_status($type, $module, $templateKey)
    {
        ...
        return setting(
            get_setting_email_status_key($type, $module, $templateKey),
            $default
        );
    }
}

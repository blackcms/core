...
return [
    ...
    "general" => [
        ...
        "admin_style_sidebar" => "Enable admin style sidebar?",
        ...
        "seo_block_description" =>
            "Setting site title, site meta description, site keyword for optimize SEO",
        "webmaster_tools_description" =>
            "Google Webmaster Tools (GWT) is free software that helps you manage the technical side of your website",
        ...
        "admin_login_screen_backgrounds" =>
            "Login screen backgrounds (~1366x768)",
    ],
    "email" => [
        "subject" => "Subject",
        "content" => "Content",
        ...
        "confirm_message" =>
            "Do you really want to reset this email template to default?",
        "continue" => "Continue",
        ...
        "using_queue_to_send_mail" =>
            "Using queue job to send emails (Must to setup Queue first https://laravel.com/docs/queues#supervisor-configuration)",
    ],
    "media" => [
        "title" => "Media",
        "driver" => "Driver",
        ...
        "media_do_spaces_cdn_custom_domain_placeholder" =>
        ...
        "turn_off_automatic_url_translation_into_latin" =>
            "Turn off automatic URL translation into Latin?",
        "bunnycdn_hostname" => "Hostname",
        "bunnycdn_zone" => "Zone Name (The name of your storage zone)",
        "bunnycdn_key" =>
            "FTP & API Access Password (The storage zone API Access Password)",
        "bunnycdn_region" => "Region (The storage zone region)",
        "optional" => "Optional",
        "sizes" => "Media thumbnails sizes",
        "media_sizes_helper" =>
            'Set width or height to 0 if you just want to crop by width or height. Need to click on "Generate thumbnails" to apply changes.',
        "width" => "Width",
        "height" => "Height",
        "default_size_value" => "Default: :size",
        "all" => "All",
        "media_folders_can_add_watermark" =>
            "Add watermark for images in folders:",
    ],
    ...
    "enable" => "Enable",
    "send" => "Send",
    "test_email_description" =>
        "To send test email, please make sure you are updated configuration to send mail!",
    "test_email_input_placeholder" =>
        "Enter the email which you want to send test email.",
    ...
    "generate_thumbnails_success" =>
        "Generate thumbnails successfully. :count files are generated!",
    "generate_thumbnails_error" =>
        "We are unable to regenerate thumbnail for these files :count files!",
    "generate_thumbnails_description" =>
        "Are you sure you want to re-generate thumbnails for all images? It will take time so please DO NOT leave this page, wait until it is finished.",
    "enable_chunk_description" =>
        "Chunk size upload is used to upload large file size.",
    "watermark_description" =>
        'WARNING: Watermark is just added to new uploaded images, it won\'t be added to existing images. Disable watermark won\'t remove watermark from existing images.',
];

                                ...
                                <div class="ui-select-wrapper">
                                    <select name="locale" class="ui-select form-control select-search-full" id="locale">
                                        @php
                                            ...
                                            if (app()->environment('demo') && session('site-locale') && array_key_exists(session('site-locale'), \BlackCMS\Base\Supports\Language::getAvailableLocales())) {
                                                $defaultLocale = session('site-locale');
                                            }
                                        @endphp
                                        @foreach (\BlackCMS\Base\Supports\Language::getAvailableLocales() as $key => $locale)
                ...
                <div class="col-12">
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <select hidden name="default_admin_theme" id="default_admin_theme">
                            ...
                            <div class="form-group mb-3">
                                <input type="hidden" name="admin_style_sidebar" value="0">
                                <label>
                                    <input type="checkbox"  value="1" @if (setting('admin_style_sidebar')) checked @endif name="admin_style_sidebar">
                                        {{ trans('core/setting::setting.general.admin_style_sidebar') }}
                                    </label>
                            </div>

...
@section('content')
    ...
    <div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div data-type="s3" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 's3') hidden @endif">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="next-input" name="media_aws_bucket" id="media_aws_bucket"
                                    value="{{ config('filesystems.disks.s3.bucket') }}" placeholder="Ex: blackcms">
                            </div>
                            <div class="form-group mb-3">
                                <label class="text-title-field"
                                ...
                                <input type="text" class="next-input" name="media_aws_url" id="media_aws_url"
                                    value="{{ config('filesystems.disks.s3.url') }}" placeholder="Ex: https://s3-ap-southeast-1.amazonaws.com/blackcms">
                            </div>
                        ...
                        <div data-type="do_spaces" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'do_spaces') hidden @endif">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="next-input" name="media_do_spaces_bucket" id="media_do_spaces_bucket"
                                    value="{{ config('filesystems.disks.do_spaces.bucket') }}" placeholder="Ex: blackcms">
                            </div>
                            <div class="form-group mb-3">
                                <label class="text-title-field"
                        ...
                        <div data-type="wasabi" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'wasabi') hidden @endif">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="next-input" name="media_wasabi_bucket" id="media_wasabi_bucket"
                                    value="{{ config('filesystems.disks.wasabi.bucket') }}" placeholder="Ex: blackcms">
                            </div>
                            <div class="form-group mb-3">
                                <label class="text-title-field"
                        ...
                        <div data-type="bunnycdn" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'bunnycdn') hidden @endif">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="next-input" name="media_bunnycdn_hostname" id="media_bunnycdn_hostname"
                                    value="{{ setting('media_bunnycdn_hostname') }}" placeholder="Ex: blackcms.b-cdn.net">
                            </div>
                            <div class="form-group mb-3">
                                <label class="text-title-field"
                                ...
                                <input type="text" class="next-input" name="media_bunnycdn_zone" id="media_bunnycdn_zone"
                                    value="{{ setting('media_bunnycdn_zone') }}" placeholder="Ex: blackcms">
                            </div>
                            <div class="form-group mb-3">
                                <label class="text-title-field"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <label class="me-2">
                                <input type="radio" name="media_turn_off_automatic_url_translation_into_latin"
                                    value="1"
                                    @if (MediaManagement::turnOffAutomaticUrlTranslationIntoLatin()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label>
                                <input type="radio" name="media_turn_off_automatic_url_translation_into_latin"
                                    value="0"
                                    @if (!MediaManagement::turnOffAutomaticUrlTranslationIntoLatin()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                            </label>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <label class="me-2">
                                <input type="radio" name="media_chunk_enabled" class="setting-selection-option" data-target="#media-chunk-settings"
                                    value="1"
                                    @if (MediaManagement::isChunkUploadEnabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label>
                                <input type="radio" name="media_chunk_enabled" class="setting-selection-option" data-target="#media-chunk-settings"
                                    value="0"
                                    @if (!MediaManagement::isChunkUploadEnabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                            </label>

                            {{ Form::helper(trans('core/setting::setting.enable_chunk_description')) }}
                        </div>

                        <div id="media-chunk-settings" class="mb-4 border rounded-top rounded-bottom p-3 bg-light @if (!MediaManagement::isChunkUploadEnabled()) d-none @endif">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="text-title-field"
                                        ...
                                        <input type="number" class="next-input" name="media_chunk_size" id="media_chunk_size"
                                            value="{{ setting('media_chunk_size', MediaManagement::getConfig('chunk.chunk_size')) }}" placeholder="{{ trans('core/setting::setting.media.chunk_size_placeholder') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="next-input" name="media_max_file_size" id="media_max_file_size"
                                            value="{{ setting('media_max_file_size', MediaManagement::getConfig('chunk.max_file_size')) }}" placeholder="{{ trans('core/setting::setting.media.max_file_size_placeholder') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <label class="me-2">
                                <input type="radio" name="media_watermark_enabled" class="setting-selection-option" data-target="#media-watermark-settings"
                                    value="1"
                                    @if (setting('media_watermark_enabled', MediaManagement::getConfig('watermark.enabled'))) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label>
                                <input type="radio" name="media_watermark_enabled" class="setting-selection-option" data-target="#media-watermark-settings"
                                    value="0"
                                    @if (!setting('media_watermark_enabled', MediaManagement::getConfig('watermark.enabled'))) checked @endif>{{ trans('core/setting::setting.general.no') }}
                            </label>
                        </div>

                        <div id="media-watermark-settings" class="mb-4 border rounded-top rounded-bottom p-3 bg-light @if (!setting('media_watermark_enabled', MediaManagement::getConfig('watermark.enabled'))) d-none @endif">
                            <div class="mb-3">
                                ...
                                <div class="form-group form-group-no-margin">
                                    <div class="multi-choices-widget list-item-checkbox">
                                        <ul>
                                            ...
                                            @foreach (app(\BlackCMS\Media\Repositories\Interfaces\MediaFolderInterface::class)->pluck('name', 'id') as $key => $item)
                                                <li>
                                                    <input type="checkbox"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="next-input" name="media_watermark_size" id="media_watermark_size"
                                            value="{{ setting('media_watermark_size', MediaManagement::getConfig('watermark.size')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_size_placeholder') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="next-input" name="watermark_opacity" id="watermark_opacity"
                                            value="{{ setting('watermark_opacity', MediaManagement::getConfig('watermark.opacity')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_opacity_placeholder') }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="ui-select-wrapper">
                                            <select name="media_watermark_position" class="ui-select" id="media_watermark_position">
                                                <option value="top-left" @if (setting('media_watermark_position', MediaManagement::getConfig('watermark.position')) == 'top-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_left') }}</option>
                                                <option value="top-right" @if (setting('media_watermark_position', MediaManagement::getConfig('watermark.position')) == 'top-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_right') }}</option>
                                                <option value="bottom-left" @if (setting('media_watermark_position', MediaManagement::getConfig('watermark.position')) == 'bottom-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_left') }}</option>
                                                <option value="bottom-right" @if (setting('media_watermark_position', MediaManagement::getConfig('watermark.position')) == 'bottom-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_right') }}</option>
                                                <option value="center" @if (setting('media_watermark_position', MediaManagement::getConfig('watermark.position')) == 'center' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_center') }}</option>
                                            </select>
                                            <svg class="svg-next-icon svg-next-icon-size-16">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                            </svg>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="next-input" name="watermark_position_x" id="watermark_position_x"
                                            value="{{ setting('watermark_position_x', MediaManagement::getConfig('watermark.x')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_position_x') }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="next-input" name="watermark_position_y" id="watermark_position_y"
                                            value="{{ setting('watermark_position_y', MediaManagement::getConfig('watermark.y')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_position_y') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            @foreach(MediaManagement::getSizes() as $name => $size)
                                @php $sizeExploded = explode('x', $size); @endphp
                                @if (count($sizeExploded) > 0)
                                    <div class="form-group mb-3">
                                        <label class="text-title-field">{{ str_replace('-', ' ', Str::title(Str::slug($name))) }} <small>({{ trans('core/setting::setting.media.default_size_value', ['size' => MediaManagement::getConfig('sizes.' . $name)]) }})</small></label>
                                        <div class="row">
                                            <div class="col-md-6">
        ...
        <div class="row col-12" style="border: none">
            <div class="col-12">
                &nbsp;
            </div>
            <div class="col-12">
                <button class="btn btn-primary" type="submit">{{ trans('core/setting::setting.save_settings') }}</button> &nbsp;
                <button class="btn btn-primary generate-thumbnails-trigger-button" type="button" data-saving="{{ trans('core/setting::setting.saving') }}">{{ trans('core/setting::setting.generate_thumbnails') }}</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}

    {!! Form::modalAction('generate-thumbnails-modal', trans('core/setting::setting.generate_thumbnails'), 'warning', trans('core/setting::setting.generate_thumbnails_description'), 'generate-thumbnails-button', trans('core/setting::setting.generate')) !!}
@endsection

...
@section('content')
    ...
    <div class="email-settings">
        @if (config('core.setting.general.enable_email_smtp_settings', true))
            ...
            <div class="col-12">
                <div class="card" id="email-config-form">
                    <div class="card-body">
                        ...
                        <div data-type="sendmail" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'sendmail') hidden @endif">
                            <div class="form-group mb-3">
                                ...
                                <span class="alert-help">{{ trans('core/setting::setting.email.default') }}: <code>{{ config('mail.mailers.sendmail.path') }}</code></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <button class="btn btn-primary send-test-email-trigger-button" type="button" data-saving="{{ trans('core/setting::setting.saving') }}">{{ trans('core/setting::setting.test_send_mail') }}</button>
                        </div>
                    </div>
                </div>
            </div>

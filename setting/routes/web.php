        ...
        Route::group(
            ...
            function () {
                Route::group(["prefix" => "settings"], function () {
                    ...
                    Route::group(
                        ["prefix" => "email", "permission" => "settings.email"],
                        function () {
                            Route::get("", [
                                "as" => "settings.email",
                            ...
                            Route::post("edit", [
                                ...
                                "uses" =>
                                    "SettingController@postEditEmailConfig",
                            ]);

                            Route::get(
                                "templates/edit/{type}/{name}/{template_file}",
                                [
                                    "as" => "setting.email.template.edit",
                                    "uses" =>
                                        "SettingController@getEditEmailTemplate",
                                ]
                            );
                            ...
                            Route::post("template/edit", [
                                ...
                                "uses" =>
                                    "SettingController@postStoreEmailTemplate",
                            ]);

                            Route::post("template/reset-to-default", [
                                "as" =>
                                    "setting.email.template.reset-to-default",
                                "uses" =>
                                    "SettingController@postResetToDefault",
                            ]);

                            Route::post("status", [
                                "as" => "setting.email.status.change",
                                "uses" =>
                                    "SettingController@postChangeEmailStatus",
                            ]);

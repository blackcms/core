...
if (!defined("BASE_FILTER_REGISTER_CONTENT_TABS")) {
    define(
        ...
        "register_platform_content_tabs"
    );
}
...
if (!defined("BASE_FILTER_REGISTER_CONTENT_TAB_INSIDE")) {
    define(
        ...
        "register_platform_content_tab_inside"
    );
}
...
if (!defined("BASE_FILTER_BEFORE_GET_BY_SLUG")) {
    define(
        "BASE_FILTER_BEFORE_GET_BY_SLUG",
        "before_get_home_page_data_by_slug"
    );
}
...
if (!defined("BASE_FILTER_BEFORE_GET_ADMIN_SINGLE_ITEM")) {
    define(
        "BASE_FILTER_BEFORE_GET_ADMIN_SINGLE_ITEM",
        "before_get_admin_single_item"
    );
}
...
if (!defined("BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM")) {
    define(
        "BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM",
        "base_filter_after_login_or_register_form"
    );
}
...
if (!defined("BASE_FILTER_FORM_EDITOR_BUTTONS")) {
    define(
        "BASE_FILTER_FORM_EDITOR_BUTTONS",
        "base_filter_form_editor_buttons"
    );
}
...
if (!defined("BASE_FILTER_SITE_LANGUAGE_DIRECTION")) {
    define(
        "BASE_FILTER_SITE_LANGUAGE_DIRECTION",
        "base_filter_site_language_direction"
    );
}
...
if (!defined("BASE_FILTER_ADMIN_LANGUAGE_DIRECTION")) {
    define(
        "BASE_FILTER_ADMIN_LANGUAGE_DIRECTION",
        "base_filter_admin_language_direction"
    );
}
...
if (!defined("BASE_FILTER_FOOTER_LAYOUT_TEMPLATE")) {
    define(
        "BASE_FILTER_FOOTER_LAYOUT_TEMPLATE",
        "base_filter_footer_layout_template"
    );
}
...
if (!defined("BASE_FILTER_HEADER_LAYOUT_TEMPLATE")) {
    define(
        "BASE_FILTER_HEADER_LAYOUT_TEMPLATE",
        "base_filter_headerer_layout_template"
    );
}

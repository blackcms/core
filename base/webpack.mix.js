...
mix.sass(source + "/resources/assets/sass/core.scss", dist + "/css")
    .sass(source + "/resources/assets/sass/custom/email.scss", dist + "/css")
    .sass(
        source + "/resources/assets/sass/custom/error-pages.scss",
        dist + "/css"
    )
    ...
    .js(source + "/resources/assets/js/taxonomies.js", dist + "/js")
    ...
    .js(source + "/resources/assets/js/tree-location.js", dist + "/js")
    .vue()

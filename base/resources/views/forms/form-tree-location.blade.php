...
@section('content')
    @php
        $locations = $form->getFormOption('locations', collect());
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card tree-locations-container position-relative">
                <div class="tree-loading">
                    @include('core/base::elements.loading')
                </div>
                <div class="tree-locations-body card-body">
                    <div class="mb-3 d-flex">
                        ...
                        @if ($createRoute)
                            <a class="tree-locations-create btn btn-primary mx-2
                    ...
                    <div class="file-tree-wrapper" data-url="{{ $indexRoute ? route($indexRoute) : '' }}">
                        @include('core/base::forms.partials.tree-locations')
                    </div>
                </div>
            </div>
        </div>

            ...
            <div class="alert alert-primary">
                ...
                <div id="report-wrapper">
                    <textarea name="txt-report" id="txt-report" class="col-sm-12" rows="10" spellcheck="false" onfocus="this.select()">
                        ...
                        - {{ trans('core/base::system.lang_dir_writable') }}: {!! $systemEnv['lang_dir_writable'] ? '&#10004;' : '&#10008;' !!}
                    ...
                    <button id="copy-report" class="btn btn-primary btn-sm">{{ trans('core/base::system.copy_report') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-4">
            <div class="card meta-boxes">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">{{ trans('core/base::system.lang_dir_writable') }}: {!! $systemEnv['lang_dir_writable'] ? '<span class="fas fa-check"></span>' : '<span class="fas fa-times"></span>' !!}</li>

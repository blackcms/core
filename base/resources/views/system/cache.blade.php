...
@section('content')
    <div class="card card meta-boxes">
        ...
        <table class="table table-bordered vertical-middle table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-block btn-clear-cache" data-type="refresh_compiled_views" data-url="{{ route('system.cache.clear') }}">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success btn-block btn-clear-cache" data-type="clear_config_cache" data-url="{{ route('system.cache.clear') }}">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success btn-block btn-clear-cache" data-type="clear_route_cache" data-url="{{ route('system.cache.clear') }}">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success btn-block btn-clear-cache" data-type="clear_log" data-url="{{ route('system.cache.clear') }}">

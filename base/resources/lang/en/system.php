...
return [
    ...
    "cannot_revoke_yourself" =>
        "Can not revoke supper user access permission yourself!",
    "cant_remove_supper" =>
        'You don\'t has permission to remove this super user',
    "cant_find_user_with_email" =>
        "Unable to find user with specified email address",
    ...
    "lang_dir_writable" => "Lang Dir Writable",
    "app_size" => "App Size",

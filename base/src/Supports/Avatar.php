...
class Avatar
{
     ...
     * @var array
     */
    protected $availableForegrounds = ["#FFFFFF"];
    ...
    {
        $this->foreground = $this->getRandomElement(
            $this->availableForegrounds,
            $this->foreground
        );
        $this->background = $this->getRandomElement(
    ...
    protected function createShape()
    {
        ...
        throw new InvalidArgumentException(
            "Shape [" . $this->shape . "] currently not supported."
        );
    }
    ...
    protected function createSquareShape()
    {
        ...
        $this->image->rectangle($edge, $edge, $width, $height, function (
            AbstractShape $draw
        ) {
            $draw->background($this->background);
            $draw->border($this->borderSize, $this->getBorderColor());

...
class FormServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        Form::component("helper", "core/base::forms.partials.helper", [
            "content",
        ]);
        ...
        Form::component(
            "customCheckbox",
            "core/base::forms.partials.custom-checkbox",
            [
                /**
                 * @var array $values
                 * @template: [
        ...
        Form::component(
            "customRadio",
            "core/base::forms.partials.custom-radio",
            [
                /**
                 * @var string $name
                 */
        ...
        Form::component(
            "customSelect",
            "core/base::forms.partials.custom-select",
            [
                "name",
                "list" => [],
                "selected" => null,
        ...
        Form::component(
            "autocomplete",
            "core/base::forms.partials.autocomplete",
            [
                "name",
                "list" => [],
                "selected" => null,
        ...
        Form::component(
            "googleFonts",
            "core/base::forms.partials.google-fonts",
            [
                "name",
                "selected" => null,
                "selectAttributes" => [],

...
namespace BlackCMS\Base\Forms;

use Assets;
use BlackCMS\Base\Forms\Fields\AutocompleteField;
use BlackCMS\Base\Forms\Fields\ColorField;
use BlackCMS\Base\Forms\Fields\CustomRadioField;
use BlackCMS\Base\Forms\Fields\CustomSelectField;
use BlackCMS\Base\Forms\Fields\DateField;
use BlackCMS\Base\Forms\Fields\EditorField;
use BlackCMS\Base\Forms\Fields\HtmlField;
use BlackCMS\Base\Forms\Fields\MediaFileField;
use BlackCMS\Base\Forms\Fields\MediaImageField;
use BlackCMS\Base\Forms\Fields\MediaImagesField;
use BlackCMS\Base\Forms\Fields\OnOffField;
use BlackCMS\Base\Forms\Fields\RepeaterField;
use BlackCMS\Base\Forms\Fields\TimeField;
use Exception;
...
abstract class FormAbstract extends Form
{
    ...
    public function getMetaBoxes(): array
    {
        uasort($this->metaBoxes, function ($before, $after) {
            if (Arr::get($before, "priority", 0) >
                Arr::get($after, "priority", 0)
            ) {
                return 1;
            } elseif (Arr::get($before, "priority", 0) <
                Arr::get($after, "priority", 0)
            ) {
                return -1;
            }
    ...
    public function getMetaBox($name): string
    {
        ...
        return view(
            "core/base::forms.partials.meta-box",
            compact("metaBox")
        )->render();
    }

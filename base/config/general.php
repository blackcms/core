...
return [
    ...
    "base_name" => env("APP_NAME", "Pyor Team"),
    "logo" => "/vendor/core/core/base/images/logo.png",
    "favicon" => "/vendor/core/core/base/images/favicon.png",
    "admin_style_sidebar" => env("ADMIN_SIDEBAR", false),
    "editor" => [
        "ckeditor" => [
            "js" => ["/vendor/core/core/base/libraries/ckeditor/ckeditor.js"],
        ],
        "tinymce" => [
            "js" => ["/vendor/core/core/base/libraries/tinymce/tinymce.min.js"],
        ],
    ...
    "purifier" => [
        "default" => [
            ...
            "HTML.Allowed" =>
                "div,b,strong,i,em,u,a[href|title|rel|style|target],ul,ol,li,p[style],br,span[style],img[width|height|alt|src|style],button,ins[style|data-ad-client|data-ad-slot|data-ad-format|data-full-width-responsive],video[src|type|width|height|preload|controls|autoplay|autostart|poster|id|class],meta[name|content|property],link[media|type|rel|href]",
            ...
            "URI.SafeIframeRegexp" => env(
                ...
                "%^(http://|https://|//)(" .
                    env(
                        "CMS_IFRAME_ALLOWED_URLS",
                        "www.youtube.com/embed/|player.vimeo.com/video/"
                    ) .
                    ")%"
            ),
        ...
        "custom_elements" => [
            ...
            ["meta", "Inline", "Inline", "Common"],
            ["link", "Inline", "Inline", "Common"],
        ],
        "custom_attributes" => [
            ["a", "rel", "Text"],
    ...
    "phone_validation_rule" => env(
        "CMS_PHONE_VALIDATION_RULE",
        'min:8|max:15|regex:/^([0-9\s\-\+\(\)]*)$/'
    ),
    "disable_verify_csrf_token" => env("CMS_DISABLE_VERIFY_CSRF_TOKEN", false),
    "demo" => [
        "account" => [
            "username" => env("CMS_DEMO_ACCOUNT_USERNAME", "demo"),
            "password" => env("CMS_DEMO_ACCOUNT_PASSWORD", "demo"),
        ],
    ],
];

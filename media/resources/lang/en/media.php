...
return [
    ...
    "confirm_delete_description" =>
        "Your request cannot rollback. Are you sure you wanna delete these items?",
    "empty_trash_title" => "Empty trash",
    "empty_trash_description" =>
        "Your request cannot rollback. Are you sure you wanna remove all items in trash?",
    ...
    "missing_zip_archive_extension" =>
        "Please enable ZipArchive extension to download file!",
    ...
    "can_not_detect_file_type" =>
        "File type is not allowed or can not detect file type!",
    "upload_failed" =>
        "The file is NOT uploaded completely. The server allows max upload file size is :size . Please check your file size OR try to upload file again!",
    ...
    "javascript" => [
        ...
        "no_item" => [
            "all_media" => [
                "icon" => "las la-cloud-upload-alt la-2x",
                "title" => "Drop files and folders here",
                "message" => "Or use the upload button above",
            ],
            "trash" => [
                "icon" => "las la-trash-alt la-2x",
                "title" => "There is nothing in your trash currently",
                "message" =>
                    "Delete files to move them to trash automatically. Delete files from trash to remove them permanently",
            ],
            "favorites" => [
            ...
            "recent" => [
                ...
                "message" =>
                    "All recent files that you opened will be appeared here",
            ],
            "default" => [
                "icon" => "las la-sync la-2x",
                "title" => "No items",

...
namespace BlackCMS\Media\Commands;
...
class InsertWatermarkCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if (!setting(
            ...
            MediaManagement::getConfig("watermark.enabled")
        )
        ) {
        ...
        $watermarkImage = setting(
            ...
            MediaManagement::getConfig("watermark.source")
        );
        ...
        $watermarkPath = MediaManagement::getRealPath($watermarkImage);
        ...
        if ($this->option("folder")) {
            $files = $this->fileRepository->allBy(
        ...
        foreach ($files as $file) {
            try {
                ...
                if (empty($folderIds) ||
                    ...
                    MediaManagement::insertWatermark($file->url);
                }

...
class ThumbnailService
{
     ...
     * @return ThumbnailService
     */
    public function setDestinationPath(
    ...
    public function save(string $type = "fit")
    {
        ...
        switch ($type) {
            case "width":
                $thumbImage->resize($this->thumbWidth, null, function (
                    $constraint
                ) {
            ...
            case "height":
                $thumbImage->resize(null, $this->thumbHeight, function (
                    $constraint
                ) {
                    $constraint->aspectRatio();
                    $constraint->upsize();

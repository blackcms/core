...
namespace BlackCMS\Media\Chunks\Save;

use BlackCMS\Media\Chunks\ChunkFile;
use BlackCMS\Media\Chunks\Exceptions\ChunkSaveException;
use BlackCMS\Media\Chunks\Exceptions\MissingChunkFilesException;
use BlackCMS\Media\Chunks\FileMerger;
use BlackCMS\Media\Chunks\Handler\AbstractHandler;
...
class ParallelSave extends ChunkSave
{
    ...
    protected function getSavedChunksFiles()
    {
        ...
        return $this->chunkStorage->files(function ($file) use (
            $chunkFileName
        ) {
    ...
    protected function buildFullFileFromChunks()
    {
        ...
        $finalFilePath =
            $this->getChunkDirectory(true) .
            "./" .
            $this->handler()->createChunkFileName();

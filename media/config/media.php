...
return [
    ...
    "allowed_mime_types" => env(
        "MEDIA_MANAGEMENT_ALLOWED_MIME_TYPES",
    ...
    "default_image" => env(
        "MEDIA_MANAGEMENT_DEFAULT_IMAGE",
        "/vendor/core/core/base/images/placeholder.png"
    ),
    "sidebar_display" => env("MEDIA_MANAGEMENT_SIDEBAR_DISPLAY", "horizontal"), // Use "vertical" or "horizontal"
    "watermark" => [
        "enabled" => env("MEDIA_MANAGEMENT_WATERMARK_ENABLED", 0),
        "source" => env("MEDIA_MANAGEMENT_WATERMARK_SOURCE"),
        "size" => env("MEDIA_MANAGEMENT_WATERMARK_SIZE", 10),
        "opacity" => env("MEDIA_MANAGEMENT_WATERMARK_OPACITY", 70),
        "position" => env(
            "MEDIA_MANAGEMENT_WATERMARK_POSITION",
            "bottom-right"
        ),
        "x" => env("MEDIA_MANAGEMENT_WATERMARK_X", 10),
        "y" => env("MEDIA_MANAGEMENT_WATERMARK_Y", 10),
    ],

    "chunk" => [
        "enabled" => env("MEDIA_MANAGEMENT_UPLOAD_CHUNK", false),

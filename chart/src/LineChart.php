...
namespace BlackCMS\Chart;

use BlackCMS\Chart\Supports\Chart;
...
class LineChart extends Chart
{
    ...
    /**
     * A function that accepts Date objects and formats them for display as x-axis labels.
     * Overrides the default formatter chosen by the automatic labeler or the xLabels option.
     *

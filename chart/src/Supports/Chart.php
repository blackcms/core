...
namespace BlackCMS\Chart\Supports;
...
class Chart extends Base
{
    ...
    /**
     * A list of strings containing names of attributes that contain Y values.
     *
     * @brief YKeys
     *
     * @var array
     ...
     * the row under the hover legend, the options object passed to the constructor as arguments,
     * and a string containing the default generated hover legend content HTML.
     * eg:
     *
     ...
     * If you list fewer colors here than you have lines in goals,

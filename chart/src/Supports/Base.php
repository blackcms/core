...
class Base
{
     ...
     * @var array
     */
    protected $functions = ["hoverCallback", "formatter", "dateFormat"];
    ...
    public function toArray()
    {
        ...
        foreach ($this as $property => $value) {
            ...
            if (in_array($property, $this->functions) &&
                substr($value, 0, 8) == "function"
            ) {
                $value = "%" . $property . "%";
            }
    ...
    public function toJSON()
    {
        ...
        return str_replace(
            ['"%hoverCallback%"', '"%formatter%"', '"%dateFormat%"'],
            [$this->hoverCallback, $this->formatter, $this->dateFormat],
            $json
        );
    }
    ...
    {
        Assets::addStyles(["morris"])->addScripts(["morris", "raphael"]);

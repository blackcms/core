                                ...
                                <div class="avatar-view mt-card-avatar mt-overlay-1">
                                    ...
                                    @if ($canChangeProfile)
                                        <div class="mt-overlay">
                                            <ul class="mt-info">
                                                <li>
                                                    <a class="btn default rounded-0 btn-outline" href="javascript:;">
                                                        <i class="icon-note"></i>
                                                    </a>
                                                </li>
                                            </ul>
                        ...
                        <div class="modal-content">
                            <form class="avatar-form" method="post" action="{{ route('users.profile.image', $user->id) }}" enctype="multipart/form-data">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="avatar-modal-label"><strong>{{ trans('core/acl::users.change_profile_image') }}</strong></h4>

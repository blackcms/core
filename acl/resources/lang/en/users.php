...
return [
    "delete_user_logged_in" =>
        'Can\'t delete this user. This user is logged on!',
    ...
    "username_exist" =>
        "That username address already belongs to an existing account",
    ...
    "cannot_delete_super_user" =>
        "Permission denied. Cannot delete a super user!",

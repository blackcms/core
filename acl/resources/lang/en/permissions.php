...
return [
    "notices" => [
        ...
        "role_delete_belong_user" =>
            "You are not able to delete this role; it belongs to someone else!",
        "role_edit_belong_user" =>
            "You are not able to edit this role; it belongs to someone else!",
    ...
    "save" => "Save",
    "global_role_msg" =>
        "This is a global role and cannot be modified.  You can use the Duplicate button to make a copy of this role that you can then modify.",
    "details" => "Details",
    "duplicate" => "Duplicate",
    "all" => "All Permissions",

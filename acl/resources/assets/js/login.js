...
$(document).ready(() => {
    ...
    var passwordConfirmation = document.querySelector(
    ...
    if (username) {
        ...
        document.getElementById("groupEmail").classList.add("focused");
        ...
        username.addEventListener("focusout", function () {
            document.getElementById("groupEmail").classList.remove("focused");
        });
    }
    ...
    if (password) {
        password.addEventListener("focusin", function () {
            document.getElementById("groupPassword").classList.add("focused");
        });

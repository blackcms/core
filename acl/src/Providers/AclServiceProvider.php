...
use BlackCMS\ACL\Http\Middleware\Authenticate;
use BlackCMS\ACL\Http\Middleware\RedirectIfAuthenticated;
use BlackCMS\ACL\Models\Activation;
use BlackCMS\ACL\Models\Role;
use BlackCMS\ACL\Models\User;
use BlackCMS\ACL\Repositories\Caches\RoleCacheDecorator;
use BlackCMS\ACL\Repositories\Eloquent\ActivationRepository;
use BlackCMS\ACL\Repositories\Eloquent\RoleRepository;
use BlackCMS\ACL\Repositories\Eloquent\UserRepository;
...
class AclServiceProvider extends ServiceProvider
{
    ...
    protected function garbageCollect()
    {
        ...
        $this->sweep(
            $this->app->make(ActivationInterface::class),

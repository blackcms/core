...
use BlackCMS\ACL\Notifications\ResetPasswordNotification;
use BlackCMS\ACL\Traits\PermissionTrait;
use BlackCMS\Base\Supports\Avatar;
...
class User extends Authenticatable
{
    ...
    {
        if ($this->avatar->url) {
            return MediaManagement::url($this->avatar->url);
        }

        try {
            return (new Avatar())->create($this->name)->toBase64();
        } catch (Exception $exception) {
            return MediaManagement::getDefaultImage();
        }
    }

    ...
    */
    ...
    public function showLoginForm()
    {
        ...
        Assets::addScripts(["jquery-validation"])
            ...
            ->removeScripts(["select2", "fancybox", "cookie"]);
    ...
    public function login(Request $request)
    {
        ...
        $user = app(UserInterface::class)->getFirstBy([
        ...
        if ($this->attemptLogin($request)) {
            app(UserInterface::class)->update(
                ["id" => $user->id],
                ["last_login" => now()]
            );

...
use BlackCMS\ACL\Forms\RoleForm;
...
use BlackCMS\ACL\Tables\RoleTable;
...
class RoleController extends BaseController
{
    ...
    public function destroy($id, BaseHttpResponse $response)
    {
        ...
        return $response->setMessage(
            trans("core/acl::permissions.delete_success")
        );
    }
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(
            trans("core/acl::permissions.details") . " - " . e($role->name)
        );

        return $formBuilder
            ->create(RoleForm::class, ["model" => $role])
            ->renderForm();
    }
    ...
    public function store(
        ...
        $role = $this->roleRepository->createOrUpdate([
            ...
            "slug" => $this->roleRepository->createSlug(
                $request->input("name"),
                0
            ),
     ...
     * @param BaseHttpResponse $response
     */
    public function postAssignMember(
        Request $request,
        BaseHttpResponse $response
    ) {

...
if (!defined("AUTH_MODULE_NAME")) {
    define("AUTH_MODULE_NAME", "auth");
}

if (!defined("USER_MODULE_NAME")) {
    define("USER_MODULE_NAME", "user");
}
...
if (!defined("ACL_FILTER_PROFILE_FORM_TAB_CONTENTS")) {
    define(
        "ACL_FILTER_PROFILE_FORM_TAB_CONTENTS",
        "acl_filter_profile_tab_contents"
    );
}

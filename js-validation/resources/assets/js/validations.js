$.extend(true, laravelValidation, {
    methods: {
        ...
        Confirmed: function (value, element, params) {
            return laravelValidation.methods.Same.call(
                this,
                value,
                element,
                params
        ...
        InArray: function (value, element, params) {
            ...
            var found = false;
            var nameRegExp = laravelValidation.helpers.regexFromWildcard(
                params[0]
            );
            ...
            fr.onload = function () {
                ...
                img.onload = function () {
                    ...
                    var notValid =
                        ...
                        (params["ratio"] &&
                            ratio !== parseFloat(eval(params["ratio"])));
                    callback(!notValid);
                };
        ...
        DateFormat: function (value, element, params) {
            return (
                laravelValidation.helpers.parseTime(value, params[0]) !== false
            );
        },

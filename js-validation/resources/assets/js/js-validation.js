    ...
    arrayRules: function (element) {
        ...
        $.each(validator.settings.rules, function (name, tmpRules) {
            if (name in cache[element.name]) {
                ...
                var nameRegExp =
                    laravelValidation.helpers.regexFromWildcard(name);
    ...
    setupValidations: function () {
        ...
        $.validator.addMethod(
            ...
            function (value, element, params) {
                ...
                $.each(rules, function (i, param) {
                    var implicit =
                        param[3] ||
                        laravelValidation.implicitRules.indexOf(param[0]) !==
                            -1;
                    var rule = param[0];
                    var message = param[2];
        ...
        $.validator.addMethod(
            ...
            function (value, element, params) {
                ...
                if (
                    laravelValidation.helpers.arrayEquals(
                        previous.old,
                        value
                    ) ||
                    previous.old === value
                ...
                if (
                    $(validator.currentForm).find('input[name="_method"]')
                        .length
                ) {

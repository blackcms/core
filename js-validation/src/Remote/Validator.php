...
namespace BlackCMS\JsValidation\Remote;

use BlackCMS\JsValidation\Support\AccessProtectedTrait;
...
class Validator
{
    ...
    public function validate($field, $parameters = [])
    {
        ...
        $validationResult = $this->validateJsRemoteRequest(
            $attribute,
            $validationParams
        );
    ...
    protected function parseParameters($parameters)
    {
        ...
        if (isset($parameters[0])) {
            $newParams["validate_all"] =
                $parameters[0] === "true" ? true : false;
        }

...
use BlackCMS\JsValidation\Exceptions\PropertyNotFoundException;
use Exception;
...
class JavascriptValidator implements Arrayable
{
    ...
    {
        $this->selector = empty($options["selector"])
            ? "form"
            : $options["selector"];
        $this->view = empty($options["view"])

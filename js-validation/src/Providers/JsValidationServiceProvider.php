...
namespace BlackCMS\JsValidation\Providers;

use BlackCMS\Base\Traits\LoadAndPublishDataTrait;
use BlackCMS\JsValidation\Javascript\ValidatorHandler;
use BlackCMS\JsValidation\JsValidatorFactory;
use BlackCMS\JsValidation\RemoteValidationMiddleware;
...
class JsValidationServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (
            $this->app["config"]->get(
                "core.js-validation.js-validation.disable_remote_validation"
            ) === false
        ) {
            $this->app[Kernel::class]->pushMiddleware(
                RemoteValidationMiddleware::class
            );
        }
    }
    ...
    protected function bootstrapValidator()
    {
        ...
        $this->app["validator"]->extend(
            ValidatorHandler::JS_VALIDATION_DISABLE,
            $callback
        );
    }

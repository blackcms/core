    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h4 class="modal-title"><strong>{{ trans('core/dashboard::dashboard.confirm_hide') }}</strong></h4>
        ...
        <div class="modal-content">
            {!! Form::open(['route' => 'dashboard.hide_widgets']) !!}
                <div class="modal-header">
                    <h4 class="modal-title"><strong>{{ trans('core/dashboard::dashboard.manage_widgets') }}</strong></h4>
                ...
                <div class="modal-body with-padding">
                    @foreach ($widgets as $widget)
                        ...
                        <section class="wrap_{{ $widget->name }}">
                            <i class="bg-primary {{ $widget->icon ?? 'lab la-buromobelexperte la-2x' . $widget->name }} @if ($widget_setting && $widget_setting->status == 0) widget_none_color @endif"></i>
